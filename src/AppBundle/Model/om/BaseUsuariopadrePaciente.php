...
abstract class BaseUsuariopadrePaciente extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AppBundle\\Model\\UsuariopadrePacientePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        UsuariopadrePacientePeer
     */
    ...
    /**
     * The value for the upp_descripcion field.
     * @var        string
     */
    protected $upp_descripcion;
    ...
    /**
     * Get the [upp_descripcion] column value.
     *
     * @return string
     */
    public function getUppDescripcion()
    {

        return $this->upp_descripcion;
    }
     ...
     * @return UsuariopadrePaciente The current object (for fluent API support)
     */
    public function setPacId($v)
    {
        ...
        if ($this->pac_id !== $v) {
            $this->pac_id = $v;
            $this->modifiedColumns[] = UsuariopadrePacientePeer::PAC_ID;
        }
    ...
    public function setUpaId($v)
    {
        ...
        if ($this->upa_id !== $v) {
            $this->upa_id = $v;
            $this->modifiedColumns[] = UsuariopadrePacientePeer::UPA_ID;
        }
    ...
    public function setUprId($v)
    {
        ...
        if ($this->upr_id !== $v) {
            $this->upr_id = $v;
            $this->modifiedColumns[] = UsuariopadrePacientePeer::UPR_ID;
        }
    ...
    /**
     * Set the value of [upp_descripcion] column.
     *
     * @param  string $v new value
     * @return UsuariopadrePaciente The current object (for fluent API support)
     */
    public function setUppDescripcion($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->upp_descripcion !== $v) {
            $this->upp_descripcion = $v;
            $this->modifiedColumns[] = UsuariopadrePacientePeer::UPP_DESCRIPCION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UsuariopadrePacientePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UsuariopadrePacientePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->upa_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->upr_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->upp_descripcion = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 6; // 6 = UsuariopadrePacientePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UsuariopadrePaciente object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UsuariopadrePacientePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UsuariopadrePacienteQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(UsuariopadrePacientePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(UsuariopadrePacientePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(UsuariopadrePacientePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                UsuariopadrePacientePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuariopadrePacientePeer::PAC_ID)) {
            $modifiedColumns[':p' . $index++]  = '`pac_id`';
        }
        if ($this->isColumnModified(UsuariopadrePacientePeer::UPA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`upa_id`';
        }
        if ($this->isColumnModified(UsuariopadrePacientePeer::UPR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`upr_id`';
        }
        if ($this->isColumnModified(UsuariopadrePacientePeer::UPP_DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`upp_descripcion`';
        }
        if ($this->isColumnModified(UsuariopadrePacientePeer::CREATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `usuariopadre_paciente` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`upr_id`':
                        ...
                        break;
                    case '`upp_descripcion`':
                        $stmt->bindValue($identifier, $this->upp_descripcion, PDO::PARAM_STR);
                        break;
                    case '`created_at`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UsuariopadrePacientePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UsuariopadrePacientePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UsuariopadrePaciente'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UsuariopadrePaciente'][serialize($this->getPrimaryKey())] = true;
        $keys = UsuariopadrePacientePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPacId(),
            $keys[1] => $this->getUpaId(),
            $keys[2] => $this->getUprId(),
            $keys[3] => $this->getUppDescripcion(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setUpaId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setUprId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setUppDescripcion($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuariopadrePacientePeer::PAC_ID)) $criteria->add(UsuariopadrePacientePeer::PAC_ID, $this->pac_id);
        if ($this->isColumnModified(UsuariopadrePacientePeer::UPA_ID)) $criteria->add(UsuariopadrePacientePeer::UPA_ID, $this->upa_id);
        if ($this->isColumnModified(UsuariopadrePacientePeer::UPR_ID)) $criteria->add(UsuariopadrePacientePeer::UPR_ID, $this->upr_id);
        if ($this->isColumnModified(UsuariopadrePacientePeer::UPP_DESCRIPCION)) $criteria->add(UsuariopadrePacientePeer::UPP_DESCRIPCION, $this->upp_descripcion);
        if ($this->isColumnModified(UsuariopadrePacientePeer::CREATED_AT)) $criteria->add(UsuariopadrePacientePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(UsuariopadrePacientePeer::UPDATED_AT)) $criteria->add(UsuariopadrePacientePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(UsuariopadrePacientePeer::DATABASE_NAME);
        $criteria->add(UsuariopadrePacientePeer::PAC_ID, $this->pac_id);
        $criteria->add(UsuariopadrePacientePeer::UPA_ID, $this->upa_id);
        $criteria->add(UsuariopadrePacientePeer::UPR_ID, $this->upr_id);
    ...
    {
        $this->setPacId($keys[0]);
        $this->setUpaId($keys[1]);
        $this->setUprId($keys[2]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getPacId()) && (null === $this->getUpaId()) && (null === $this->getUprId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of UsuariopadrePaciente (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUppDescripcion($this->getUppDescripcion());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UsuariopadrePaciente Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UsuariopadrePacientePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UsuariopadrePacientePeer();
        }
    ...
    public function setPaciente(Paciente $v = null)
    {
        ...
        if ($v !== null) {
            $v->addUsuariopadrePaciente($this);
        }
    ...
    public function getPaciente(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPaciente === null && ($this->pac_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPaciente->addUsuariopadrePacientes($this);
             */
        }
    ...
    public function getUsuarioPadre(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuarioPadre === null && ($this->upa_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuarioPadre->addUsuariopadrePacientes($this);
             */
        }
    ...
    public function getUsuarioProfesional(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuarioProfesional === null && ($this->upr_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuarioProfesional->addUsuariopadrePacientes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UsuariopadrePacientePeer::DEFAULT_STRING_FORMAT);
    }
