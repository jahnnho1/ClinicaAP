...
abstract class BaseUsuarioAdministrativo extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AppBundle\\Model\\UsuarioAdministrativoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        UsuarioAdministrativoPeer
     */
    ...
    /**
     * The value for the usu_rut field.
     * @var        string
     */
    protected $usu_rut;
     ...
     * @return UsuarioAdministrativo The current object (for fluent API support)
     */
    public function setUsuId($v)
    {
        ...
        if ($this->usu_id !== $v) {
            $this->usu_id = $v;
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::USU_ID;
        }
    ...
    public function setCliId($v)
    {
        ...
        if ($this->cli_id !== $v) {
            $this->cli_id = $v;
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::CLI_ID;
        }
    ...
    public function setUsuNombre($v)
    {
        ...
        if ($this->usu_nombre !== $v) {
            $this->usu_nombre = $v;
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::USU_NOMBRE;
        }
    ...
    public function setUsuApellido($v)
    {
        ...
        if ($this->usu_apellido !== $v) {
            $this->usu_apellido = $v;
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::USU_APELLIDO;
        }
    ...
    public function setUsuEmail($v)
    {
        ...
        if ($this->usu_email !== $v) {
            $this->usu_email = $v;
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::USU_EMAIL;
        }
    ...
    /**
     * Set the value of [usu_rut] column.
     *
     * @param  string $v new value
     * @return UsuarioAdministrativo The current object (for fluent API support)
     */
    public function setUsuRut($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->usu_rut !== $v) {
            $this->usu_rut = $v;
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::USU_RUT;
        }
    ...
    public function setUsuClave($v)
    {
        ...
        if ($this->usu_clave !== $v) {
            $this->usu_clave = $v;
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::USU_CLAVE;
        }
    ...
    public function setUsuEstado($v)
    {
        ...
        if ($this->usu_estado !== $v) {
            $this->usu_estado = $v;
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::USU_ESTADO;
        }
    ...
    /**
     * Set the value of [usu_eliminado] column.
     *
     * @param  int $v new value
     * @return UsuarioAdministrativo The current object (for fluent API support)
     */
    public function setUsuEliminado($v)
    {
        ...
        if ($this->usu_eliminado !== $v) {
            ...
            $this->modifiedColumns[] = UsuarioAdministrativoPeer::USU_ELIMINADO;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UsuarioAdministrativoPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UsuarioAdministrativoPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->usu_email = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->usu_rut = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->usu_clave = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->usu_estado = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->usu_eliminado = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            ...
            return $startcol + 11; // 11 = UsuarioAdministrativoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UsuarioAdministrativo object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UsuarioAdministrativoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UsuarioAdministrativoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(UsuarioAdministrativoPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(UsuarioAdministrativoPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(UsuarioAdministrativoPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                UsuarioAdministrativoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_ID)) {
            $modifiedColumns[':p' . $index++]  = '`usu_id`';
        }
        if ($this->isColumnModified(UsuarioAdministrativoPeer::CLI_ID)) {
            $modifiedColumns[':p' . $index++]  = '`cli_id`';
        }
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`usu_nombre`';
        }
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_APELLIDO)) {
            $modifiedColumns[':p' . $index++]  = '`usu_apellido`';
        }
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`usu_email`';
        }
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_RUT)) {
            $modifiedColumns[':p' . $index++]  = '`usu_rut`';
        }
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_CLAVE)) {
            $modifiedColumns[':p' . $index++]  = '`usu_clave`';
        }
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_ESTADO)) {
            $modifiedColumns[':p' . $index++]  = '`usu_estado`';
        }
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_ELIMINADO)) {
        ...
        $sql = sprintf(
            'INSERT INTO `usuario_administrativo` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`usu_email`':
                        ...
                        break;
                    case '`usu_rut`':
                        $stmt->bindValue($identifier, $this->usu_rut, PDO::PARAM_STR);
                        break;
                    case '`usu_clave`':
                    ...
                    case '`usu_estado`':
                        ...
                        break;
                    case '`usu_eliminado`':
                        $stmt->bindValue($identifier, $this->usu_eliminado, PDO::PARAM_INT);
                        break;
                    case '`created_at`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UsuarioAdministrativoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UsuarioAdministrativoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UsuarioAdministrativo'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UsuarioAdministrativo'][$this->getPrimaryKey()] = true;
        $keys = UsuarioAdministrativoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getUsuId(),
            $keys[1] => $this->getCliId(),
            $keys[2] => $this->getUsuNombre(),
            $keys[3] => $this->getUsuApellido(),
            $keys[4] => $this->getUsuEmail(),
            $keys[5] => $this->getUsuRut(),
            $keys[6] => $this->getUsuClave(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setUsuEmail($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setUsuRut($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setUsuClave($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_ID)) $criteria->add(UsuarioAdministrativoPeer::USU_ID, $this->usu_id);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::CLI_ID)) $criteria->add(UsuarioAdministrativoPeer::CLI_ID, $this->cli_id);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_NOMBRE)) $criteria->add(UsuarioAdministrativoPeer::USU_NOMBRE, $this->usu_nombre);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_APELLIDO)) $criteria->add(UsuarioAdministrativoPeer::USU_APELLIDO, $this->usu_apellido);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_EMAIL)) $criteria->add(UsuarioAdministrativoPeer::USU_EMAIL, $this->usu_email);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_RUT)) $criteria->add(UsuarioAdministrativoPeer::USU_RUT, $this->usu_rut);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_CLAVE)) $criteria->add(UsuarioAdministrativoPeer::USU_CLAVE, $this->usu_clave);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_ESTADO)) $criteria->add(UsuarioAdministrativoPeer::USU_ESTADO, $this->usu_estado);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::USU_ELIMINADO)) $criteria->add(UsuarioAdministrativoPeer::USU_ELIMINADO, $this->usu_eliminado);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::CREATED_AT)) $criteria->add(UsuarioAdministrativoPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(UsuarioAdministrativoPeer::UPDATED_AT)) $criteria->add(UsuarioAdministrativoPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(UsuarioAdministrativoPeer::DATABASE_NAME);
        $criteria->add(UsuarioAdministrativoPeer::USU_ID, $this->usu_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UsuarioAdministrativo (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUsuRut($this->getUsuRut());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UsuarioAdministrativo Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UsuarioAdministrativoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UsuarioAdministrativoPeer();
        }
    ...
    public function setClinica(Clinica $v = null)
    {
        ...
        if ($v !== null) {
            $v->addUsuarioAdministrativo($this);
        }
    ...
    public function getClinica(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aClinica === null && ($this->cli_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aClinica->addUsuarioAdministrativos($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UsuarioAdministrativoPeer::DEFAULT_STRING_FORMAT);
    }
