...
abstract class BaseEspecialidad extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'AppBundle\\Model\\EspecialidadPeer';
    ...
    public function setUprId($v)
    {
        ...
        if ($this->upr_id !== $v) {
            $this->upr_id = $v;
            $this->modifiedColumns[] = EspecialidadPeer::UPR_ID;
        }
    ...
    public function setTesId($v)
    {
        ...
        if ($this->tes_id !== $v) {
            $this->tes_id = $v;
            $this->modifiedColumns[] = EspecialidadPeer::TES_ID;
        }

        if ($this->aTipoEspecialidad !== null && $this->aTipoEspecialidad->getTesId() !== $v) {
            $this->aTipoEspecialidad = null;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EspecialidadPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tes_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = EspecialidadPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aTipoEspecialidad !== null && $this->tes_id !== $this->aTipoEspecialidad->getTesId()) {
            $this->aTipoEspecialidad = null;
        }
    } // ensureConsistency
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(EspecialidadPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(EspecialidadPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTipoEspecialidad !== null) {
                if ($this->aTipoEspecialidad->isModified() || $this->aTipoEspecialidad->isNew()) {
                    $affectedRows += $this->aTipoEspecialidad->save($con);
                }
                $this->setTipoEspecialidad($this->aTipoEspecialidad);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EspecialidadPeer::UPR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`upr_id`';
        }
        if ($this->isColumnModified(EspecialidadPeer::TES_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aTipoEspecialidad !== null) {
                if (!$this->aTipoEspecialidad->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aTipoEspecialidad->getValidationFailures());
                }
            }
    ...
    {
        if (isset($alreadyDumpedObjects['Especialidad'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Especialidad'][serialize($this->getPrimaryKey())] = true;
        $keys = EspecialidadPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getUprId(),
            $keys[1] => $this->getTesId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aTipoEspecialidad) {
                $result['TipoEspecialidad'] = $this->aTipoEspecialidad->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setTesId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EspecialidadPeer::UPR_ID)) $criteria->add(EspecialidadPeer::UPR_ID, $this->upr_id);
        if ($this->isColumnModified(EspecialidadPeer::TES_ID)) $criteria->add(EspecialidadPeer::TES_ID, $this->tes_id);
        if ($this->isColumnModified(EspecialidadPeer::CREATED_AT)) $criteria->add(EspecialidadPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(EspecialidadPeer::UPDATED_AT)) $criteria->add(EspecialidadPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(EspecialidadPeer::DATABASE_NAME);
        $criteria->add(EspecialidadPeer::UPR_ID, $this->upr_id);
        $criteria->add(EspecialidadPeer::TES_ID, $this->tes_id);
    ...
    {
        $this->setUprId($keys[0]);
        $this->setTesId($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getUprId()) && (null === $this->getTesId());
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTesId($this->getTesId());
    ...
    public function getUsuarioProfesional(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuarioProfesional === null && ($this->upr_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUsuarioProfesional->addEspecialidads($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a TipoEspecialidad object.
     *
     * @param                  TipoEspecialidad $v
     * @return Especialidad The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTipoEspecialidad(TipoEspecialidad $v = null)
    {
        if ($v === null) {
            $this->setTesId(NULL);
        } else {
            $this->setTesId($v->getTesId());
        }

        $this->aTipoEspecialidad = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the TipoEspecialidad object, it will not be re-added.
        if ($v !== null) {
            $v->addEspecialidad($this);
        }
    ...
    /**
     * Get the associated TipoEspecialidad object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return TipoEspecialidad The associated TipoEspecialidad object.
     * @throws PropelException
     */
    public function getTipoEspecialidad(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTipoEspecialidad === null && ($this->tes_id !== null) && $doQuery) {
            $this->aTipoEspecialidad = TipoEspecialidadQuery::create()->findPk($this->tes_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTipoEspecialidad->addEspecialidads($this);
             */
        }

        return $this->aTipoEspecialidad;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aTipoEspecialidad instanceof Persistent) {
              $this->aTipoEspecialidad->clearAllReferences($deep);
            }
